package com.yjl.constant;

/**
 * @author yjl
 * @create 2020-07-27-20:29
 **/
public class MessageConstant {
    ...
    public static final String EDIT_PERMISSION_FAIL = "修改角色权限失败";
    public static final String EDIT_PERMISSION_SUCCESS = "修改角色权限成功";
